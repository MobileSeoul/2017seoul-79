...
public class profile_b_adapter extends RecyclerView.Adapter<profile_b_adapter.ViewHolder> {

    private Context context;
    private List<pro_b> item;
    private Integer[] tagImage = new Integer[12];

    public profile_b_adapter(List<pro_b> item, Context context) {
        super();
        this.item = item;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        final pro_b item1 = item.get(position);
