...
public class up_c_adapter extends RecyclerView.Adapter<up_c_adapter.ViewHolder> {

    private Context context;
    private List<up_cc> item;
    private Integer[] tagImage = new Integer[12];

    public up_c_adapter(List<up_cc> item, Context context) {
        super();
        this.item = item;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        final up_cc item1 = item.get(position);
